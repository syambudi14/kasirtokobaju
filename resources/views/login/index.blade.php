...
<head>
    ...
    <title>Cashier Login | Premium Store</title>
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            <div class="card-header">
                ...
                <h1>Welcome Back</h1>
                <p>Enter your credentials to access the cashier system</p>
            </div>
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email" placeholder="karyawan@toko.com" required>
                    </div>
                </div>
